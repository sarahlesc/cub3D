...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2021/05/03 18:24:32 by slescure          #+#    #+#             */
/*   Updated: 2021/05/03 23:41:18 by slescure         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int		init_music(t_data *data)
{
	...
	return_value = system("aplay -q bonus/sound/music_boo.wav &>/dev/null &");
	return (return_value);
}
...
int		play_music(t_data *data)
{
		...
		/ (double)clk_tck >= 129.5)
	{
		...
		return_value =
			system("aplay -q bonus/sound/music_boo.wav &>/dev/null &");
