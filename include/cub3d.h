...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2021/05/03 18:33:29 by slescure          #+#    #+#             */
/*   Updated: 2021/05/04 13:08:09 by slescure         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int			check_holes_walls(char **map, int nb_lines,
				int length, t_param *param);
int			check_first_last_string_map(char *str, t_param *param);

int			check_all_para(t_param *param, char **tab_param);
int			p_orientation_position(char *map, t_param *param,
				int position, int i);
...
int			ft_char_is_string(char c, char *str);
...
void		draw_sprites(t_data *data, int stripe,
			int text_x, t_sprite *sprite);
...
void		draw_sprites_2(t_data *data, t_sprite *sprite,
			int img_c, int sprite_c);
